...
function SignUp() {
  ...
  function handleSignupSubmitButton() {
    ...
    localStorage.setItem(
      'user',
      JSON.stringify([...userDataFromLocal, changeUserData()])
    );
    navigate('/loginapp');
  }
      ...
      <div className="signup-function-container">
        <div className="signup-function">
          ...
          <div className="signup-submit-btn-box">
            <Button onClick={handleSignupSubmitButton} type={'submit'}>
              가입
            </Button>
            <Button onClick={handleSignupCancelButton} type={'submit'}>
              취소
            </Button>
          </div>
        </div>
